      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <button
            ...
            style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#334155', padding: '2px', display: 'flex', alignItems: 'center', lineHeight: 1, transition: 'color 0.15s' }}
        ...
        {isMobileViewport ? (
          ...
          <span style={{ color: '#06B6D4', fontSize: '11px', backgroundColor: 'rgba(6,182,212,0.08)', border: '1px solid rgba(6,182,212,0.15)', padding: '3px 8px', borderRadius: '6px', fontWeight: 600 }}>
